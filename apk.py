...
# Initialize session state for recorded audio and uploaded files
...
# Function to extract features from audio signal
...
def audiorec_ver1():
    ...
    # Load the model and genre mapping
    ...
    # Save recorded audio to session state
    if wav_audio_data is not None:
        st.session_state['recorded_audio'] = wav_audio_data

    # Predict genre from recorded audio
    ...
    # Predict genre from uploaded file
